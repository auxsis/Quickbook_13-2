...
class ResConfigSettings(models.TransientModel):
    ...
    shopify_instance_prefix = fields.Char("Instance Prefix",
                                          help="This field is used to set prefix with the shopify's"
                                          " variant_id in odoo product's barcode.")
    ...
    def onchange_shopify_instance_id(self):
        ...
        if instance:
            ...
            self.shopify_instance_prefix = instance.shopify_instance_prefix
            ...
            try:
                shopify_order_import_cron_exist = self.env.ref(
            ...
            try:
                shopify_order_update_cron_exist = self.env.ref(
    ...
    def execute(self):
        ...
        if instance:
            ...
            # account Fields
            values['shopify_property_account_payable_id'] = self.shopify_property_account_payable_id and self.shopify_property_account_payable_id.id or False
            values['shopify_property_account_receivable_id'] = self.shopify_property_account_receivable_id and self.shopify_property_account_receivable_id.id or False

            values["shopify_instance_prefix"] = self.shopify_instance_prefix
